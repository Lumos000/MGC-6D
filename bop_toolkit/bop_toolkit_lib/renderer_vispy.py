...
# Allow backend override from environment.
# Examples:
#   BOP_VISPY_APP_BACKEND=egl
#   BOP_VISPY_APP_BACKEND=pyglet
#   BOP_VISPY_GL_BACKEND=gl2
app_backend = os.environ.get("BOP_VISPY_APP_BACKEND", "egl")
gl_backend = os.environ.get("BOP_VISPY_GL_BACKEND", "gl2")
if app_backend == "egl" and "PYOPENGL_PLATFORM" not in os.environ:
