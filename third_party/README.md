...
This repository contains or interfaces with third-party research code:

- `foundationpose/`: FoundationPose code and extensions, under its own license.
- `instantmesh/`: InstantMesh code, under its own license.
- `sam2/`: Segment Anything 2 code, under its own license.
